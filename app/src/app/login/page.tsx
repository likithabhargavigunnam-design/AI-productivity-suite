    ...
    <main className="min-h-screen hero-gradient flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black mb-2">Welcome to AI Suite</h1>
          <p className="text-sm text-gray-400">Sign in to access your productivity dashboard</p>
        </div>
        ...
        <div className="glass p-8">
          ...
          <div className="mt-6 text-center text-xs text-gray-500 leading-relaxed">
            By signing in, you agree to our terms of service. Your data is secured with Row-Level Security on Supabase.
          </div>
        </div>
